...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "iLink Tanzania engineers bespoke ICT and marketing solutions across 16 brands and four operational pillars." },
      { property: "og:title", content: "iLink Tanzania — Bridging Ideas with Reality" },
      { property: "og:description", content: "iLink Tanzania engineers bespoke ICT and marketing solutions across 16 brands and four operational pillars." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "iLink Tanzania — Bridging Ideas with Reality" },
      { name: "twitter:description", content: "iLink Tanzania engineers bespoke ICT and marketing solutions across 16 brands and four operational pillars." },
